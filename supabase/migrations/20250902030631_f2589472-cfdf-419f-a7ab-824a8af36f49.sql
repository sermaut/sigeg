-- Drop all existing policies on system_admins first
...
-- Update existing admin to super_admin if MB_0608 exists
UPDATE public.system_admins 
SET permission_level = 'super_admin' 
WHERE access_code = 'MB_0608';

-- Create new simplified RLS policies that work with session-based authentication
